...
<p><b>Кладовка КБА. Остаток. (Начальная страница)</b></p>
  ...
  <fieldset id="block3" name="searchGroup" style="border:0px solid grey; display:inline;">
	...
	<table>
	  <tr>
		...
		<td class="search"><input style="margin-left: 3em;" type="text" name="name" id="search1" value="<?php echo $checkboxes['name']; ?>"></td>
	  ...
	  <tr>
		...
		<td class="search"><input style="margin-left: 3em;" type="text" name="code" id="search2" value="<?php echo $checkboxes['code']; ?>"></td>
	  ...
	  <tr>
		...
		<td class="search"><input style="margin-left: 3em;" type="text" name="ksp" id="search3" value="<?php echo $checkboxes['ksp']; ?>"></td>

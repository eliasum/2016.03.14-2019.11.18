...
global $noteVal;                                             // глобальные переменные
...
if(isset($_POST['savenote_exp']))                            // если кнопка 'savenote_exp' была нажата
{
  ...
  */
  ...
  if($noteVal!=null)                                         // если поле 'примечание' не пустое 
  {
	...
	mysql_query(" 
				UPDATE `expenses` 
				SET `note_exp`='$noteVal'
				WHERE `id`='$id' 
				") or die(mysql_error());  // запрос на обновление полей таблицы expenses, установить поле note_exp с id='$id' значением переменной $noteVal
...
{
?>
<input type="text" name="noteField" value="<?php echo $row['note_exp'] // записать в поле значение из БД ?>" /><br/><br/>  
<?php  
}
?>

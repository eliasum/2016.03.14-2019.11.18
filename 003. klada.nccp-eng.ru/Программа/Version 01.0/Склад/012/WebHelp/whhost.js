...
{
	var padding = (gsPageDir == "ltr")?"padding-left":"padding-right";
	var directionHorizontal = (gsPageDir == "ltr")?"left":"right";
	return "<div id=\""+gsLoadingDivID+"\" style=\"position:absolute;top:0;" + directionHorizontal + 
	":0;z-index:600;visibility:hidden;" +padding+ ":4px;background-color:ivory;border-width:1;border-style:solid;border-color:black;width:150px;\">"+gsLoadingMsg+"</div>";
}

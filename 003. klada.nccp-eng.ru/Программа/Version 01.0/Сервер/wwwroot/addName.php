    ...
    { 	  
      if($answer==1)                                           // если пользователь подтвердил ввод
	  {
		...
		mysql_query(" 
					...
					") or die(mysql_error());  // запрос на вставку в поля таблицы equips соответствующих значений из переменных
		...
		mysql_query(" 
					...
					") or die(mysql_error());  // запрос на вставку в поля таблицы incomes соответствующих значений из переменных

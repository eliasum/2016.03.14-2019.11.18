...
*/
            ...
            string[] namesOfTeams = new string[teams];
            int[] keysOfTeams = new int[teams];
            int[] parentsOfTeams = new int[teams];

            // Создать массивы фамилий и подразделений пользователей: 
            string[] arrOfNames1 = new string[notFired];
            int[] arrOfTeams = new int[notFired];
            int[] arrOfKeys = new int[notFired];
            ...
            //или кратко foreach (var kvp in array)
            {
                ...
                {
                    arrOfNames1[index1] = kvp.Value.name1;                  // запись фамилий в массив arrOfNames1

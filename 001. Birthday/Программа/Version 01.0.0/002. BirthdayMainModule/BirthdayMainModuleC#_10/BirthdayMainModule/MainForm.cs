...
namespace BirthdayMainModule
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void remind()
        {
            ...
            if (strOfDobs != null) notifyIcon1.ShowBalloonTip(15000, "Внимание!", strOfDobs, ToolTipIcon.Info);
        }
        ...
        private void SearchInTree()
        {
            ...
            if (SelectedNode != null)
            {
                ...
                this.treeView1.SelectedNode.EnsureVisible();                    // показывает положение выбранного узла в дереве
        ...
        {
            string uJson = null;
            string pathUsersGet = pathMyDirectory + @"\usersGet.json";
        ...
        {
            string aJson = null;
            string pathAuthStart = pathMyDirectory + @"\authStart.json";
        ...
        {
            string tJson = null;
            string pathTeamsGet = pathMyDirectory + @"\teamsGet.json";
        ...
        {
            string jJson = null;
            string pathJobsGet = pathMyDirectory + @"\jobsGet.json";

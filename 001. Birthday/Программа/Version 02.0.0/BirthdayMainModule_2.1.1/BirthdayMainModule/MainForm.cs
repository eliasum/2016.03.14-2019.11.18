...
namespace Birthday
{
    ...
    {
        public static bool f_debugMode;                 // флаг сохранения режима отладки 
        public static bool f_hide = false;
        ...
        public MainForm()
        {
            ...
            f_debugMode = Settings.Default.debugMode;
        ...
        private void remind()
        {
            ...
            {
                if (f_debugMode) MessageBox.Show("remind: " + ex.Message);
                Log.Write(ex);
            }
            /////////////////////////////////////////////////////////////////////////////////////////
            ...
            else
            {
                ...
                //или кратко foreach (var kvp in array1)
                {
                    ...
                    int teamParent = Convert.ToInt32(kvp.Value.parent);      // родитель подразделения
                                                                             ...
                                                                             Запрещенные отделы:
                                                                             НЕ ИСПОЛЬЗОВАТЬ 100
                                                                             Коммерческий отдел 3041

                                                                             Группа по разработке систем автоматики (РСА) 2123
                                                                             Группа разработки технических средств управления оборудованием (РТСУО) 2124
                                                                             Группа радиационных методов контроля (РМК) 2141
                                                                             Группа радиационных методов контроля (РМК) 10
                                                                             Группа радиационных методов контроля (РМК) 38
                                                                             Группа ультразвуковой дефектоскопии (УД) 2143
                                                                             Группа ультразвуковой дефектоскопии (УД) 12
                                                                             Группа ультразвуковой дефектоскопии (УД) 40
                                                                             Лаборатория адаптации (ЛА) 2160
                                                                             Участок механической обработки (М.г. 16) 23
                                                                             Группа технологического контроля (ТК) 2142
                                                                             Группа технологического контроля (ТК) 11
                                                                             Группа технологического контроля (ТК) 39
                                                                             Группа автоматики и контроля технологических процессов (АКТП) 2121
                                                                             */
                    if (teamKey != 100  && teamKey != 3041 && teamKey != 2123 && teamKey != 2124
                     && teamKey != 2141 && teamKey != 10   && teamKey != 38   && teamKey != 2143
                     && teamKey != 12   && teamKey != 40   && teamKey != 2160 && teamKey != 23
                     && teamKey != 2142 && teamKey != 11   && teamKey != 39   && teamKey != 2121) // исключить запрещенные отделы
                    {
        ...
        private void SearchInTree()
        {
            ...
            try
            {
                ...
                this.tV_Tree.SelectedNode.BackColor = System.Drawing.Color.Empty;
                this.tV_Tree.SelectedNode.ForeColor = System.Drawing.Color.Black;
            }
            catch (Exception ex)
            {
            ...
            {
                // нашли, выделяем...
                this.tV_Tree.SelectedNode = SelectedNode;
                this.tV_Tree.SelectedNode.Expand();
                ...
                try
                {
                    ...
                    this.tV_Tree.SelectedNode.BackColor = System.Drawing.ColorTranslator.FromHtml("#3399FF");
                    this.tV_Tree.SelectedNode.ForeColor = System.Drawing.Color.White;
                }
                catch (Exception ex)
                {
                    if (f_debugMode) MessageBox.Show("SearchInTree: " + ex.Message);

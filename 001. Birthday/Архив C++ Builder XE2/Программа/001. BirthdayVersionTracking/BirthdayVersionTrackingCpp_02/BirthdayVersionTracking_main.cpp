...
AnsiString __fastcall TMainForm::GetAnyAppParam(AnsiString appname,AnsiString pname)  // получение версии файла
{
...
//---------------------------------------------------------------------------
String __fastcall TMainForm::GetVer(String FileName)  // получение версии файла
{
  AnsiString Version;
  DWORD h;

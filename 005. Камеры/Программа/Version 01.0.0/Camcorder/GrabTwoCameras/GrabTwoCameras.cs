...
namespace GrabTwoCameras
{
    ...
    class GrabTwoCameras
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region Handles for the pylon devices
            ...
            try
            {
                ...
                #region Enumerate all camera devices
                ...
                #region Open cameras and set parameters. 
                ...
                #region Grab until the timer expires
            ...
            {
                #region Retrieve the error message
